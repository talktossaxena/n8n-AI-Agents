...
<br>🚀 Trigger: You manually start the workflow by clicking 'Execute'.
...
-🤖 AI Generation: It uses Claude Opus 4.7 to craft a fresh, unique whatsapp message for every recipient.
